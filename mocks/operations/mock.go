...
// Source: bazel-out/darwin_arm64-fastbuild/bin/api/tools/gosdk/mocks/operations/gopath/src/nebius.ai/nebo/api/tools/gosdk/operations/operation.go
//
// Generated by this command:
//
//	mockgen -source bazel-out/darwin_arm64-fastbuild/bin/api/tools/gosdk/mocks/operations/gopath/src/nebius.ai/nebo/api/tools/gosdk/operations/operation.go -package operations -typed
//
...
// WaitInterval mocks base method.
func (m *MockOperation) WaitInterval(arg0 context.Context, arg1 time.Duration, arg2 ...grpc.CallOption) (operations.Operation, error) {
	m.ctrl.T.Helper()
	varargs := []any{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "WaitInterval", varargs...)
	ret0, _ := ret[0].(operations.Operation)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// WaitInterval indicates an expected call of WaitInterval.
func (mr *MockOperationMockRecorder) WaitInterval(arg0, arg1 any, arg2 ...any) *MockOperationWaitIntervalCall {
	mr.mock.ctrl.T.Helper()
	...
	return &MockOperationWaitIntervalCall{Call: call}
}

// MockOperationWaitIntervalCall wrap *gomock.Call
type MockOperationWaitIntervalCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockOperationWaitIntervalCall) Return(arg0 operations.Operation, arg1 error) *MockOperationWaitIntervalCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockOperationWaitIntervalCall) Do(f func(context.Context, time.Duration, ...grpc.CallOption) (operations.Operation, error)) *MockOperationWaitIntervalCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockOperationWaitIntervalCall) DoAndReturn(f func(context.Context, time.Duration, ...grpc.CallOption) (operations.Operation, error)) *MockOperationWaitIntervalCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
