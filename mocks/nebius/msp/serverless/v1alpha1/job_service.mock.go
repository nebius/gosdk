...
// Source: services/nebius/msp/serverless/v1alpha1/job_service.sdk.go
//
// Generated by this command:
//
//	mockgen -source services/nebius/msp/serverless/v1alpha1/job_service.sdk.go -package v1alpha1 -typed
//
...
func (m *MockJobService) Delete(arg0 context.Context, arg1 *v1alpha10.DeleteRequest, arg2 ...grpc.CallOption) (operations.Operation, error) {
	m.ctrl.T.Helper()
	varargs := []any{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
// Do rewrite *gomock.Call.Do
func (c *MockJobServiceDeleteCall) Do(f func(context.Context, *v1alpha10.DeleteRequest, ...grpc.CallOption) (operations.Operation, error)) *MockJobServiceDeleteCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockJobServiceDeleteCall) DoAndReturn(f func(context.Context, *v1alpha10.DeleteRequest, ...grpc.CallOption) (operations.Operation, error)) *MockJobServiceDeleteCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// Filter mocks base method.
func (m *MockJobService) Filter(arg0 context.Context, arg1 *v1alpha10.ListRequest, arg2 ...grpc.CallOption) iter.Seq2[*v1alpha1.Job, error] {
	m.ctrl.T.Helper()
	varargs := []any{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
// Do rewrite *gomock.Call.Do
func (c *MockJobServiceFilterCall) Do(f func(context.Context, *v1alpha10.ListRequest, ...grpc.CallOption) iter.Seq2[*v1alpha1.Job, error]) *MockJobServiceFilterCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockJobServiceFilterCall) DoAndReturn(f func(context.Context, *v1alpha10.ListRequest, ...grpc.CallOption) iter.Seq2[*v1alpha1.Job, error]) *MockJobServiceFilterCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// Get mocks base method.
func (m *MockJobService) Get(arg0 context.Context, arg1 *v1alpha10.GetRequest, arg2 ...grpc.CallOption) (*v1alpha1.Job, error) {
	m.ctrl.T.Helper()
	varargs := []any{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
// Do rewrite *gomock.Call.Do
func (c *MockJobServiceGetCall) Do(f func(context.Context, *v1alpha10.GetRequest, ...grpc.CallOption) (*v1alpha1.Job, error)) *MockJobServiceGetCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockJobServiceGetCall) DoAndReturn(f func(context.Context, *v1alpha10.GetRequest, ...grpc.CallOption) (*v1alpha1.Job, error)) *MockJobServiceGetCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (m *MockJobService) List(arg0 context.Context, arg1 *v1alpha10.ListRequest, arg2 ...grpc.CallOption) (*v1alpha1.ListJobsResponse, error) {
	m.ctrl.T.Helper()
	varargs := []any{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
// Do rewrite *gomock.Call.Do
func (c *MockJobServiceListCall) Do(f func(context.Context, *v1alpha10.ListRequest, ...grpc.CallOption) (*v1alpha1.ListJobsResponse, error)) *MockJobServiceListCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockJobServiceListCall) DoAndReturn(f func(context.Context, *v1alpha10.ListRequest, ...grpc.CallOption) (*v1alpha1.ListJobsResponse, error)) *MockJobServiceListCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
