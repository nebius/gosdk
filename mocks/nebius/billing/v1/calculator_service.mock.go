...
// Source: services/nebius/billing/v1/calculator_service.sdk.go
//
// Generated by this command:
//
//	mockgen -source services/nebius/billing/v1/calculator_service.sdk.go -package v1 -typed
//
...
func (m *MockCalculatorService) EstimateBatch(arg0 context.Context, arg1 *v1.EstimateBatchRequest, arg2 ...grpc.CallOption) (*v1.EstimateBatchResponse, error) {
	m.ctrl.T.Helper()
	...
	ret0, _ := ret[0].(*v1.EstimateBatchResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (c *MockCalculatorServiceEstimateBatchCall) Return(arg0 *v1.EstimateBatchResponse, arg1 error) *MockCalculatorServiceEstimateBatchCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockCalculatorServiceEstimateBatchCall) Do(f func(context.Context, *v1.EstimateBatchRequest, ...grpc.CallOption) (*v1.EstimateBatchResponse, error)) *MockCalculatorServiceEstimateBatchCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockCalculatorServiceEstimateBatchCall) DoAndReturn(f func(context.Context, *v1.EstimateBatchRequest, ...grpc.CallOption) (*v1.EstimateBatchResponse, error)) *MockCalculatorServiceEstimateBatchCall {
