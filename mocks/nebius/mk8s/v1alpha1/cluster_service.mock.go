...
// Source: services/nebius/mk8s/v1alpha1/cluster_service.sdk.go
//
// Generated by this command:
//
//	mockgen -source services/nebius/mk8s/v1alpha1/cluster_service.sdk.go -package v1alpha1 -typed
//
...
func (m *MockClusterService) ListControlPlaneVersions(arg0 context.Context, arg1 *v1alpha10.ListClusterControlPlaneVersionsRequest, arg2 ...grpc.CallOption) (*v1alpha10.ListClusterControlPlaneVersionsResponse, error) {
	m.ctrl.T.Helper()
	varargs := []any{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*v1alpha10.ListClusterControlPlaneVersionsResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// Return rewrite *gomock.Call.Return
func (c *MockClusterServiceListControlPlaneVersionsCall) Return(arg0 *v1alpha10.ListClusterControlPlaneVersionsResponse, arg1 error) *MockClusterServiceListControlPlaneVersionsCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockClusterServiceListControlPlaneVersionsCall) Do(f func(context.Context, *v1alpha10.ListClusterControlPlaneVersionsRequest, ...grpc.CallOption) (*v1alpha10.ListClusterControlPlaneVersionsResponse, error)) *MockClusterServiceListControlPlaneVersionsCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockClusterServiceListControlPlaneVersionsCall) DoAndReturn(f func(context.Context, *v1alpha10.ListClusterControlPlaneVersionsRequest, ...grpc.CallOption) (*v1alpha10.ListClusterControlPlaneVersionsResponse, error)) *MockClusterServiceListControlPlaneVersionsCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
