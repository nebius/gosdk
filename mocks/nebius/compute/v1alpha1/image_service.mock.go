...
// Source: services/nebius/compute/v1alpha1/image_service.sdk.go
//
// Generated by this command:
//
//	mockgen -source services/nebius/compute/v1alpha1/image_service.sdk.go -package v1alpha1 -typed
//
...
func (m *MockImageService) Filter(arg0 context.Context, arg1 *v1alpha10.ListImagesRequest, arg2 ...grpc.CallOption) iter.Seq2[*v1alpha10.Image, error] {
	...
	ret0, _ := ret[0].(iter.Seq2[*v1alpha10.Image, error])
	return ret0
}
...
func (m *MockImageService) List(arg0 context.Context, arg1 *v1alpha10.ListImagesRequest, arg2 ...grpc.CallOption) (*v1alpha10.ListImagesResponse, error) {
	...
	ret0, _ := ret[0].(*v1alpha10.ListImagesResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
