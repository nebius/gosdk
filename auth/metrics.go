...
func (m *atomicMetrics) tokenRefresh(ctx context.Context, t BearerTokener, result string, duration time.Duration) {
	m.Load().TokenRefresh(ctx, metricProvider(t), result, duration, true)
}
