...
func TestShouldParseUIDBasedNID(t *testing.T) {
	...
	assertParse(
		"longtype50chars12345678901234567890123456789012345-e0taccdde35fgghdii--a1b2c3d4e5",
		"longtype50chars12345678901234567890123456789012345",
		"e0t",
		"accdde35fgghdii",
		t,
	)
...
func TestShouldParseWellKnownIDBasedNID(t *testing.T) {
	...
	assertParse(
		"longtype50chars12345678901234567890123456789012345-e0t-sha256-"+
			"5adefc5ff7bd508658fccef8b0ff217931b4392c59951f732f218780e376ceb4"+
			"--a1b2c3d4e5",
		"longtype50chars12345678901234567890123456789012345",
		"e0t",
		"-sha256-5adefc5ff7bd508658fccef8b0ff217931b4392c59951f732f218780e376ceb4",
		t,
	)
...
func TestShouldReturnErrorOnParseNIDWithInvalidLengths(t *testing.T) {
	t.Parallel()
	assertParseFailed(
		"longtype51chars12345678901234567890123456789012345x-a7b1ccdde35fgghdii",
		"type is too long",
		t,
	)
	assertParseFailed(
		"folder-long-well-known-id-98-chars-"+
