...
func (m *PoolSpec) GetSource() isPoolSpec_Source {
	if m != nil {
		return m.Source
	}
	return nil
...
func (x *PoolSpec) GetSourcePoolId() string {
	if x, ok := x.GetSource().(*PoolSpec_SourcePoolId); ok {
...
func (x *PoolSpec) GetSourceScopeId() string {
	if x, ok := x.GetSource().(*PoolSpec_SourceScopeId); ok {
...
var file_nebius_vpc_v1alpha1_pool_proto_rawDesc = []byte{
...
var (
	...
	file_nebius_vpc_v1alpha1_pool_proto_rawDescData = file_nebius_vpc_v1alpha1_pool_proto_rawDesc
)

func file_nebius_vpc_v1alpha1_pool_proto_rawDescGZIP() []byte {
	file_nebius_vpc_v1alpha1_pool_proto_rawDescOnce.Do(func() {
		file_nebius_vpc_v1alpha1_pool_proto_rawDescData = protoimpl.X.CompressGZIP(file_nebius_vpc_v1alpha1_pool_proto_rawDescData)
	})
...
func file_nebius_vpc_v1alpha1_pool_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_nebius_vpc_v1alpha1_pool_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Pool); i {
			case 0:
				return &v.state
			case 1:
		...
		file_nebius_vpc_v1alpha1_pool_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_nebius_vpc_v1alpha1_pool_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_nebius_vpc_v1alpha1_pool_proto_msgTypes[3].Exporter = func(v any, i int) any {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_nebius_vpc_v1alpha1_pool_proto_rawDesc,
			NumEnums:      3,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_nebius_vpc_v1alpha1_pool_proto_rawDesc = nil
