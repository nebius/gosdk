...
const (
	AllocationService_Get_FullMethodName       = "/nebius.vpc.v1alpha1.AllocationService/Get"
	AllocationService_GetByName_FullMethodName = "/nebius.vpc.v1alpha1.AllocationService/GetByName"
	AllocationService_List_FullMethodName      = "/nebius.vpc.v1alpha1.AllocationService/List"
	AllocationService_Create_FullMethodName    = "/nebius.vpc.v1alpha1.AllocationService/Create"
	AllocationService_Update_FullMethodName    = "/nebius.vpc.v1alpha1.AllocationService/Update"
	AllocationService_Delete_FullMethodName    = "/nebius.vpc.v1alpha1.AllocationService/Delete"
)
...
type AllocationServiceClient interface {
	...
	Create(ctx context.Context, in *CreateAllocationRequest, opts ...grpc.CallOption) (*v1alpha1.Operation, error)
	Update(ctx context.Context, in *UpdateAllocationRequest, opts ...grpc.CallOption) (*v1alpha1.Operation, error)
	Delete(ctx context.Context, in *DeleteAllocationRequest, opts ...grpc.CallOption) (*v1alpha1.Operation, error)
}
...
func (c *allocationServiceClient) Create(ctx context.Context, in *CreateAllocationRequest, opts ...grpc.CallOption) (*v1alpha1.Operation, error) {
...
func (c *allocationServiceClient) Update(ctx context.Context, in *UpdateAllocationRequest, opts ...grpc.CallOption) (*v1alpha1.Operation, error) {
	out := new(v1alpha1.Operation)
...
func (c *allocationServiceClient) Delete(ctx context.Context, in *DeleteAllocationRequest, opts ...grpc.CallOption) (*v1alpha1.Operation, error) {
	out := new(v1alpha1.Operation)
...
type AllocationServiceServer interface {
	...
	Create(context.Context, *CreateAllocationRequest) (*v1alpha1.Operation, error)
	Update(context.Context, *UpdateAllocationRequest) (*v1alpha1.Operation, error)
	Delete(context.Context, *DeleteAllocationRequest) (*v1alpha1.Operation, error)
}
...
func (UnimplementedAllocationServiceServer) Create(context.Context, *CreateAllocationRequest) (*v1alpha1.Operation, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedAllocationServiceServer) Update(context.Context, *UpdateAllocationRequest) (*v1alpha1.Operation, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Update not implemented")
}
func (UnimplementedAllocationServiceServer) Delete(context.Context, *DeleteAllocationRequest) (*v1alpha1.Operation, error) {
...
var AllocationService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "nebius.vpc.v1alpha1.AllocationService",
	...
	Metadata: "nebius/vpc/v1alpha1/allocation_service.proto",
}
