...
func (m *SubnetPool) GetPool() isSubnetPool_Pool {
	if m != nil {
		return m.Pool
	}
	return nil
...
func (x *SubnetPool) GetSpec() *SubnetPoolSpec {
	if x, ok := x.GetPool().(*SubnetPool_Spec); ok {
		return x.Spec
	}
	return nil
}
...
func (x *SubnetPool) GetPoolId() string {
	if x, ok := x.GetPool().(*SubnetPool_PoolId); ok {
		return x.PoolId
	}
	return ""
}
...
var file_nebius_vpc_v1alpha1_subnet_proto_rawDesc = []byte{
...
var (
	...
	file_nebius_vpc_v1alpha1_subnet_proto_rawDescData = file_nebius_vpc_v1alpha1_subnet_proto_rawDesc
)

func file_nebius_vpc_v1alpha1_subnet_proto_rawDescGZIP() []byte {
	file_nebius_vpc_v1alpha1_subnet_proto_rawDescOnce.Do(func() {
		file_nebius_vpc_v1alpha1_subnet_proto_rawDescData = protoimpl.X.CompressGZIP(file_nebius_vpc_v1alpha1_subnet_proto_rawDescData)
	})
...
func file_nebius_vpc_v1alpha1_subnet_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_nebius_vpc_v1alpha1_subnet_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Subnet); i {
			case 0:
				return &v.state
			case 1:
		...
		file_nebius_vpc_v1alpha1_subnet_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_nebius_vpc_v1alpha1_subnet_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*SubnetPool); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_nebius_vpc_v1alpha1_subnet_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*SubnetPoolSpec); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_nebius_vpc_v1alpha1_subnet_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*SubnetCidr); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_nebius_vpc_v1alpha1_subnet_proto_msgTypes[5].Exporter = func(v any, i int) any {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_nebius_vpc_v1alpha1_subnet_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_nebius_vpc_v1alpha1_subnet_proto_rawDesc = nil
