...
const (
	SubnetService_Get_FullMethodName           = "/nebius.vpc.v1alpha1.SubnetService/Get"
	SubnetService_GetByName_FullMethodName     = "/nebius.vpc.v1alpha1.SubnetService/GetByName"
	SubnetService_List_FullMethodName          = "/nebius.vpc.v1alpha1.SubnetService/List"
	SubnetService_ListByNetwork_FullMethodName = "/nebius.vpc.v1alpha1.SubnetService/ListByNetwork"
)
...
var SubnetService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "nebius.vpc.v1alpha1.SubnetService",
	...
	Metadata: "nebius/vpc/v1alpha1/subnet_service.proto",
}
