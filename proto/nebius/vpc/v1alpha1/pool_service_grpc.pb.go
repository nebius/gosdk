...
const (
	PoolService_Get_FullMethodName       = "/nebius.vpc.v1alpha1.PoolService/Get"
	PoolService_GetByName_FullMethodName = "/nebius.vpc.v1alpha1.PoolService/GetByName"
	PoolService_List_FullMethodName      = "/nebius.vpc.v1alpha1.PoolService/List"
)
...
var PoolService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "nebius.vpc.v1alpha1.PoolService",
	...
	Metadata: "nebius/vpc/v1alpha1/pool_service.proto",
}
