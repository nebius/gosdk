...
func file_nebius_vpc_v1_network_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_nebius_vpc_v1_network_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_nebius_vpc_v1_network_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_nebius_vpc_v1_network_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*IPv4PrivateNetworkPools); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_nebius_vpc_v1_network_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*IPv4PublicNetworkPools); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_nebius_vpc_v1_network_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_nebius_vpc_v1_network_proto_msgTypes[5].Exporter = func(v any, i int) any {
