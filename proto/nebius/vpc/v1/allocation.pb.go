...
func (m *IPv4PublicAllocationSpec) GetPool() isIPv4PublicAllocationSpec_Pool {
	if m != nil {
		return m.Pool
	}
	return nil
...
func (x *IPv4PublicAllocationSpec) GetSubnetId() string {
	if x, ok := x.GetPool().(*IPv4PublicAllocationSpec_SubnetId); ok {
		return x.SubnetId
	}
	return ""
}
...
func (x *IPv4PublicAllocationSpec) GetPoolId() string {
	if x, ok := x.GetPool().(*IPv4PublicAllocationSpec_PoolId); ok {
		return x.PoolId
	}
	return ""
}
...
var file_nebius_vpc_v1_allocation_proto_rawDesc = []byte{
...
var (
	...
	file_nebius_vpc_v1_allocation_proto_rawDescData = file_nebius_vpc_v1_allocation_proto_rawDesc
)

func file_nebius_vpc_v1_allocation_proto_rawDescGZIP() []byte {
	file_nebius_vpc_v1_allocation_proto_rawDescOnce.Do(func() {
		file_nebius_vpc_v1_allocation_proto_rawDescData = protoimpl.X.CompressGZIP(file_nebius_vpc_v1_allocation_proto_rawDescData)
	})
...
func file_nebius_vpc_v1_allocation_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_nebius_vpc_v1_allocation_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_nebius_vpc_v1_allocation_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_nebius_vpc_v1_allocation_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_nebius_vpc_v1_allocation_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_nebius_vpc_v1_allocation_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_nebius_vpc_v1_allocation_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_nebius_vpc_v1_allocation_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_nebius_vpc_v1_allocation_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_nebius_vpc_v1_allocation_proto_msgTypes[8].Exporter = func(v any, i int) any {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_nebius_vpc_v1_allocation_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_nebius_vpc_v1_allocation_proto_rawDesc = nil
