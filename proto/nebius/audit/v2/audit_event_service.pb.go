...
const file_nebius_audit_v2_audit_event_service_proto_rawDesc = "" +
	"\n" +
	")nebius/audit/v2/audit_event_service.proto\x12\x0fnebius.audit.v2\x1a\x1bbuf/validate/validate.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x18nebius/annotations.proto\x1a!nebius/audit/v2/audit_event.proto\"\xec\x02\n" +
	...
	"\n" +
	"event_type\x18\a \x01(\x0e2\x1a.nebius.audit.v2.EventTypeR\teventType\x12\x1e\n" +
	"\x06region\x18\b \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x06region\"s\n" +
