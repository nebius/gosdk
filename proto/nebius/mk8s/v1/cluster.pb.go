...
const file_nebius_mk8s_v1_cluster_proto_rawDesc = "" +
	...
	"\fkube_network\x18\x03 \x01(\v2\x1f.nebius.mk8s.v1.KubeNetworkSpecR\vkubeNetwork\"\xea\x01\n" +
	...
	"\xbaH\a\"\x052\x03\x00\x01\x03R\x0fetcdClusterSize\"n\n" +
	...
	"\x11string.valid_cidr\x12?value must be a CIDR block or prefix length from \"/12\" to \"/28\"\x1a0this.all(x, x.matches('^(.*)/(1[2-9]|2[0-8])$'))\x92\x01\x02\x10\x01\xbaJ\x01\x02R\fserviceCidrs\"\x82\x02\n" +
	"\rClusterStatus\x129\n" +
