...
const file_nebius_mk8s_v1_condition_proto_rawDesc = "" +
	"\n" +
	...
	"\x06status\x18\x02 \x01(\x0e2 .nebius.mk8s.v1.Condition.StatusR\x06status\x12H\n" +
	"\x12last_transition_at\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\x10lastTransitionAt\x12\x16\n" +
	"\x06reason\x18\x04 \x01(\tR\x06reason\x12>\n" +
	"\bseverity\x18\x05 \x01(\x0e2\".nebius.mk8s.v1.Condition.SeverityR\bseverity\x12 \n" +
	"\vdescription\x18\x06 \x01(\tR\vdescription\x12]\n" +
	"\x15last_transition_error\x18\a \x01(\v2).nebius.mk8s.v1.Condition.TransitionErrorR\x13lastTransitionError\x1aK\n" +
	...
	"\x04TRUE\x10\x01\x12\t\n" +
	"\x05FALSE\x10\x02BW\n" +
	"\x15ai.nebius.pub.mk8s.v1B\x0eConditionProtoP\x01Z,github.com/nebius/gosdk/proto/nebius/mk8s/v1b\x06proto3"
