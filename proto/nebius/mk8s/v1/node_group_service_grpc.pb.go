...
type NodeGroupServiceClient interface {
	...
	GetByName(ctx context.Context, in *v1.GetByNameRequest, opts ...grpc.CallOption) (*NodeGroup, error)
	List(ctx context.Context, in *ListNodeGroupsRequest, opts ...grpc.CallOption) (*ListNodeGroupsResponse, error)
	Create(ctx context.Context, in *CreateNodeGroupRequest, opts ...grpc.CallOption) (*v1.Operation, error)
...
func (c *nodeGroupServiceClient) GetByName(ctx context.Context, in *v1.GetByNameRequest, opts ...grpc.CallOption) (*NodeGroup, error) {
	out := new(NodeGroup)
...
func (c *nodeGroupServiceClient) Create(ctx context.Context, in *CreateNodeGroupRequest, opts ...grpc.CallOption) (*v1.Operation, error) {
...
func (c *nodeGroupServiceClient) Update(ctx context.Context, in *UpdateNodeGroupRequest, opts ...grpc.CallOption) (*v1.Operation, error) {
	out := new(v1.Operation)
...
func (c *nodeGroupServiceClient) Delete(ctx context.Context, in *DeleteNodeGroupRequest, opts ...grpc.CallOption) (*v1.Operation, error) {
	out := new(v1.Operation)
...
func (c *nodeGroupServiceClient) Upgrade(ctx context.Context, in *UpgradeNodeGroupRequest, opts ...grpc.CallOption) (*v1.Operation, error) {
	out := new(v1.Operation)
...
type NodeGroupServiceServer interface {
	...
	GetByName(context.Context, *v1.GetByNameRequest) (*NodeGroup, error)
	List(context.Context, *ListNodeGroupsRequest) (*ListNodeGroupsResponse, error)
	Create(context.Context, *CreateNodeGroupRequest) (*v1.Operation, error)
...
func (UnimplementedNodeGroupServiceServer) GetByName(context.Context, *v1.GetByNameRequest) (*NodeGroup, error) {
...
func (UnimplementedNodeGroupServiceServer) Create(context.Context, *CreateNodeGroupRequest) (*v1.Operation, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedNodeGroupServiceServer) Update(context.Context, *UpdateNodeGroupRequest) (*v1.Operation, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Update not implemented")
}
func (UnimplementedNodeGroupServiceServer) Delete(context.Context, *DeleteNodeGroupRequest) (*v1.Operation, error) {
...
func _NodeGroupService_GetByName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NodeGroupServiceServer).GetByName(ctx, req.(*v1.GetByNameRequest))
	}
	return interceptor(ctx, in, info, handler)
}
