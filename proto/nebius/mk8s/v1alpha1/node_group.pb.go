...
func (x *NodeGroupSpec) GetFixedNodeCount() int64 {
	if x, ok := x.GetSize().(*NodeGroupSpec_FixedNodeCount); ok {
...
func (x *NodeGroupSpec) GetAutoscaling() *NodeGroupAutoscalingSpec {
	if x, ok := x.GetSize().(*NodeGroupSpec_Autoscaling); ok {
...
func (x *PercentOrCount) GetPercent() int64 {
	if x, ok := x.GetValue().(*PercentOrCount_Percent); ok {
		return x.Percent
	}
	return 0
}
...
func (x *PercentOrCount) GetCount() int64 {
	if x, ok := x.GetValue().(*PercentOrCount_Count); ok {
		return x.Count
	}
	return 0
}
