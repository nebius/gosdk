...
const file_nebius_mk8s_v1alpha1_node_group_proto_rawDesc = "" +
	"\n" +
	"%nebius/mk8s/v1alpha1/node_group.proto\x12\x14nebius.mk8s.v1alpha1\x1a\x1bbuf/validate/validate.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x18nebius/annotations.proto\x1a\x1fnebius/common/v1/metadata.proto\x1a,nebius/mk8s/v1alpha1/instance_template.proto\"\xd5\x01\n" +
	"\tNodeGroup\x12P\n" +
	"\bmetadata\x18\x01 \x01(\v2\".nebius.common.v1.ResourceMetadataB\x10\xe2J\r\x12\vmk8sclusterR\bmetadata\x127\n" +
	...
	"autoRepairB\r\n" +
	"\x04size\x12\x05\xbaH\x02\b\x01\"\xbf\x06\n" +
	"\fNodeTemplate\x12F\n" +
	...
	"gpuCluster\x12k\n" +
	"\x12network_interfaces\x18\x05 \x03(\v2..nebius.mk8s.v1alpha1.NetworkInterfaceTemplateB\f\xbaH\x05\x92\x01\x02\x10\x01\xbaJ\x01\aR\x11networkInterfaces\x12N\n" +
	...
	" \x01(\tB\x13\xe2J\x10\n" +
	"\x0eserviceaccountR\x10serviceAccountId\x12M\n" +
	...
	"\x11computegpuclusterR\x02id\"\xa4\x01\n" +
