...
var file_nebius_common_error_v1alpha1_error_proto_rawDesc = []byte{
...
var (
	...
	file_nebius_common_error_v1alpha1_error_proto_rawDescData = file_nebius_common_error_v1alpha1_error_proto_rawDesc
)
...
func file_nebius_common_error_v1alpha1_error_proto_rawDescGZIP() []byte {
	file_nebius_common_error_v1alpha1_error_proto_rawDescOnce.Do(func() {
		file_nebius_common_error_v1alpha1_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_nebius_common_error_v1alpha1_error_proto_rawDescData)
	})
...
func file_nebius_common_error_v1alpha1_error_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_nebius_common_error_v1alpha1_error_proto_msgTypes[0].Exporter = func(v any, i int) any {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_nebius_common_error_v1alpha1_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_nebius_common_error_v1alpha1_error_proto_rawDesc = nil
