...
const file_nebius_compute_v1alpha1_image_proto_rawDesc = "" +
	...
	"\x06status\x18\x03 \x01(\v2$.nebius.compute.v1alpha1.ImageStatusR\x06status\"\x91\x01\n" +
	"\tImageSpec\x12+\n" +
	...
	"\aversion\x18\x03 \x01(\tB\x04\xbaJ\x01\x02R\aversionB\x0e\n" +
	"\f_description\"\xd5\x02\n" +
	"\vImageStatus\x12@\n" +
	"\x05state\x18\x01 \x01(\x0e2*.nebius.compute.v1alpha1.ImageStatus.StateR\x05state\x12+\n" +
	...
	"\x05ERROR\x10\x05Bh\n" +
	"\x1eai.nebius.pub.compute.v1alpha1B\n" +
	"ImageProtoP\x01Z5github.com/nebius/gosdk/proto/nebius/compute/v1alpha1\xb8\x01\x01b\x06proto3"

var (
	file_nebius_compute_v1alpha1_image_proto_rawDescOnce sync.Once
	file_nebius_compute_v1alpha1_image_proto_rawDescData []byte
)
...
func file_nebius_compute_v1alpha1_image_proto_rawDescGZIP() []byte {
	file_nebius_compute_v1alpha1_image_proto_rawDescOnce.Do(func() {
		file_nebius_compute_v1alpha1_image_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_nebius_compute_v1alpha1_image_proto_rawDesc), len(file_nebius_compute_v1alpha1_image_proto_rawDesc)))
	})
...
func file_nebius_compute_v1alpha1_image_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_nebius_compute_v1alpha1_image_proto_rawDesc), len(file_nebius_compute_v1alpha1_image_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
