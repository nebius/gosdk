...
const (
	GpuClusterService_Get_FullMethodName                    = "/nebius.compute.v1alpha1.GpuClusterService/Get"
	GpuClusterService_GetByName_FullMethodName              = "/nebius.compute.v1alpha1.GpuClusterService/GetByName"
	GpuClusterService_List_FullMethodName                   = "/nebius.compute.v1alpha1.GpuClusterService/List"
	GpuClusterService_Create_FullMethodName                 = "/nebius.compute.v1alpha1.GpuClusterService/Create"
	GpuClusterService_Update_FullMethodName                 = "/nebius.compute.v1alpha1.GpuClusterService/Update"
	GpuClusterService_Delete_FullMethodName                 = "/nebius.compute.v1alpha1.GpuClusterService/Delete"
	GpuClusterService_ListOperationsByParent_FullMethodName = "/nebius.compute.v1alpha1.GpuClusterService/ListOperationsByParent"
)
...
type GpuClusterServiceClient interface {
	...
	Create(ctx context.Context, in *CreateGpuClusterRequest, opts ...grpc.CallOption) (*v1alpha1.Operation, error)
	Update(ctx context.Context, in *UpdateGpuClusterRequest, opts ...grpc.CallOption) (*v1alpha1.Operation, error)
	Delete(ctx context.Context, in *DeleteGpuClusterRequest, opts ...grpc.CallOption) (*v1alpha1.Operation, error)
...
func (c *gpuClusterServiceClient) Create(ctx context.Context, in *CreateGpuClusterRequest, opts ...grpc.CallOption) (*v1alpha1.Operation, error) {
...
func (c *gpuClusterServiceClient) Update(ctx context.Context, in *UpdateGpuClusterRequest, opts ...grpc.CallOption) (*v1alpha1.Operation, error) {
	out := new(v1alpha1.Operation)
...
func (c *gpuClusterServiceClient) Delete(ctx context.Context, in *DeleteGpuClusterRequest, opts ...grpc.CallOption) (*v1alpha1.Operation, error) {
	out := new(v1alpha1.Operation)
...
func (c *gpuClusterServiceClient) ListOperationsByParent(ctx context.Context, in *v1alpha1.ListOperationsByParentRequest, opts ...grpc.CallOption) (*v1alpha1.ListOperationsResponse, error) {
...
type GpuClusterServiceServer interface {
	...
	Create(context.Context, *CreateGpuClusterRequest) (*v1alpha1.Operation, error)
	Update(context.Context, *UpdateGpuClusterRequest) (*v1alpha1.Operation, error)
	Delete(context.Context, *DeleteGpuClusterRequest) (*v1alpha1.Operation, error)
...
func (UnimplementedGpuClusterServiceServer) Create(context.Context, *CreateGpuClusterRequest) (*v1alpha1.Operation, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedGpuClusterServiceServer) Update(context.Context, *UpdateGpuClusterRequest) (*v1alpha1.Operation, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Update not implemented")
}
func (UnimplementedGpuClusterServiceServer) Delete(context.Context, *DeleteGpuClusterRequest) (*v1alpha1.Operation, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Delete not implemented")
}
func (UnimplementedGpuClusterServiceServer) ListOperationsByParent(context.Context, *v1alpha1.ListOperationsByParentRequest) (*v1alpha1.ListOperationsResponse, error) {
...
func _GpuClusterService_ListOperationsByParent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GpuClusterServiceServer).ListOperationsByParent(ctx, req.(*v1alpha1.ListOperationsByParentRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var GpuClusterService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "nebius.compute.v1alpha1.GpuClusterService",
	...
	Metadata: "nebius/compute/v1alpha1/gpu_cluster_service.proto",
}
