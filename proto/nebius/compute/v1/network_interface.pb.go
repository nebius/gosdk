...
func (x *SecurityGroup) Reset() {
	*x = SecurityGroup{}
	mi := &file_nebius_compute_v1_network_interface_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SecurityGroup) Descriptor() ([]byte, []int) {
	return file_nebius_compute_v1_network_interface_proto_rawDescGZIP(), []int{8}
}
...
var file_nebius_compute_v1_network_interface_proto_depIdxs = []int32{
	...
	8, // 3: nebius.compute.v1.NetworkInterfaceSpec.security_groups:type_name -> nebius.compute.v1.SecurityGroup
