...
func file_nebius_compute_v1_image_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_nebius_compute_v1_image_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_nebius_compute_v1_image_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_nebius_compute_v1_image_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_nebius_compute_v1_image_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
