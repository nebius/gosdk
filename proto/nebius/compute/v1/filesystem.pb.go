...
const file_nebius_compute_v1_filesystem_proto_rawDesc = "" +
	"\n" +
	"\"nebius/compute/v1/filesystem.proto\x12\x11nebius.compute.v1\x1a\x1bbuf/validate/validate.proto\x1a\x1fnebius/common/v1/metadata.proto\x1a\x18nebius/annotations.proto\"\xc0\x01\n" +
	"\n" +
	"Filesystem\x12>\n" +
	...
	"\x10block_size_bytes\x18\a \x01(\x03R\x0eblockSizeBytes\"X\n" +
	"\x05State\x12\x0f\n" +
