...
const file_nebius_compute_v1_gpu_cluster_service_proto_rawDesc = "" +
	...
	"\x11computegpuclusterR\x02id\"\xe9\x01\n" +
	...
	"\x17CreateGpuClusterRequest\x12L\n" +
	"\bmetadata\x18\x01 \x01(\v2\".nebius.common.v1.ResourceMetadataB\f\xe2J\t\x12\aprojectR\bmetadata\x125\n" +
	"\x04spec\x18\x02 \x01(\v2!.nebius.compute.v1.GpuClusterSpecR\x04spec\"\x9e\x01\n" +
	"\x17UpdateGpuClusterRequest\x12L\n" +
	"\bmetadata\x18\x01 \x01(\v2\".nebius.common.v1.ResourceMetadataB\f\xe2J\t\x12\aprojectR\bmetadata\x125\n" +
	"\x04spec\x18\x02 \x01(\v2!.nebius.compute.v1.GpuClusterSpecR\x04spec\"A\n" +
	"\x17DeleteGpuClusterRequest\x12&\n" +
	"\x02id\x18\x01 \x01(\tB\x16\xe2J\x13\n" +
	"\x11computegpuclusterR\x02id\"v\n" +
	...
	"\x06Delete\x12*.nebius.compute.v1.DeleteGpuClusterRequest\x1a\x1b.nebius.common.v1.Operation\x12\x8f\x01\n" +
