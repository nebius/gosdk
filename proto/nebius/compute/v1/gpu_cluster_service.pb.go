...
var file_nebius_compute_v1_gpu_cluster_service_proto_rawDesc = []byte{
...
var (
	...
	file_nebius_compute_v1_gpu_cluster_service_proto_rawDescData = file_nebius_compute_v1_gpu_cluster_service_proto_rawDesc
)
...
func file_nebius_compute_v1_gpu_cluster_service_proto_rawDescGZIP() []byte {
	file_nebius_compute_v1_gpu_cluster_service_proto_rawDescOnce.Do(func() {
		file_nebius_compute_v1_gpu_cluster_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_nebius_compute_v1_gpu_cluster_service_proto_rawDescData)
	})
...
func file_nebius_compute_v1_gpu_cluster_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_nebius_compute_v1_gpu_cluster_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_nebius_compute_v1_gpu_cluster_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_nebius_compute_v1_gpu_cluster_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_nebius_compute_v1_gpu_cluster_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_nebius_compute_v1_gpu_cluster_service_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_nebius_compute_v1_gpu_cluster_service_proto_msgTypes[5].Exporter = func(v any, i int) any {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_nebius_compute_v1_gpu_cluster_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_nebius_compute_v1_gpu_cluster_service_proto_rawDesc = nil
