...
func file_nebius_msp_spark_v1alpha1_preset_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_nebius_msp_spark_v1alpha1_preset_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*DriverTemplateSpec); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_nebius_msp_spark_v1alpha1_preset_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*DynamicAllocationSpec); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_nebius_msp_spark_v1alpha1_preset_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*ExecutorTemplateSpec); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
