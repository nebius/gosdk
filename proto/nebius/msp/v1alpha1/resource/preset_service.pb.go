...
func file_nebius_msp_v1alpha1_resource_preset_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_nebius_msp_v1alpha1_resource_preset_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_nebius_msp_v1alpha1_resource_preset_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
