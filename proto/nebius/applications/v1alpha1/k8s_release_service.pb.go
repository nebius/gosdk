...
func file_nebius_applications_v1alpha1_k8s_release_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_nebius_applications_v1alpha1_k8s_release_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*GetK8SReleaseRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_nebius_applications_v1alpha1_k8s_release_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*ListK8SReleasesRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_nebius_applications_v1alpha1_k8s_release_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*CreateK8SReleaseRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_nebius_applications_v1alpha1_k8s_release_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*DeleteK8SReleaseRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_nebius_applications_v1alpha1_k8s_release_service_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*ListK8SReleasesResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
