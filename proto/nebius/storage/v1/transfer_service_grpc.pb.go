...
const (
	TransferService_Get_FullMethodName                 = "/nebius.storage.v1.TransferService/Get"
	TransferService_GetByName_FullMethodName           = "/nebius.storage.v1.TransferService/GetByName"
	TransferService_List_FullMethodName                = "/nebius.storage.v1.TransferService/List"
	TransferService_Create_FullMethodName              = "/nebius.storage.v1.TransferService/Create"
	TransferService_Update_FullMethodName              = "/nebius.storage.v1.TransferService/Update"
	TransferService_Stop_FullMethodName                = "/nebius.storage.v1.TransferService/Stop"
	TransferService_Resume_FullMethodName              = "/nebius.storage.v1.TransferService/Resume"
	TransferService_Delete_FullMethodName              = "/nebius.storage.v1.TransferService/Delete"
	TransferService_GetIterationHistory_FullMethodName = "/nebius.storage.v1.TransferService/GetIterationHistory"
)
...
var TransferService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "nebius/storage/v1/transfer_service.proto",
}
