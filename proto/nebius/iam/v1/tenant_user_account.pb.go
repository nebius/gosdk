...
const file_nebius_iam_v1_tenant_user_account_proto_rawDesc = "" +
	...
	"\apicture\x18\x05 \x01(\tB\x03\xc0J\x01H\x05R\apicture\x88\x01\x01\x12x\n" +
	"\x05email\x18\x06 \x01(\tB]\xbaHW\xba\x01Q\n" +
	"\fstring.email\x12#value must be a valid email address\x1a\x1cthis == '' || this.isEmail()\xc8\x01\x00\xc0J\x01H\x06R\x05email\x88\x01\x01\x12.\n" +
