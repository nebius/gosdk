...
var file_nebius_iam_v1_access_key_proto_rawDesc = []byte{
...
var (
	...
	file_nebius_iam_v1_access_key_proto_rawDescData = file_nebius_iam_v1_access_key_proto_rawDesc
)

func file_nebius_iam_v1_access_key_proto_rawDescGZIP() []byte {
	file_nebius_iam_v1_access_key_proto_rawDescOnce.Do(func() {
		file_nebius_iam_v1_access_key_proto_rawDescData = protoimpl.X.CompressGZIP(file_nebius_iam_v1_access_key_proto_rawDescData)
	})
...
func file_nebius_iam_v1_access_key_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_nebius_iam_v1_access_key_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_nebius_iam_v1_access_key_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*AccessKeySpec); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_nebius_iam_v1_access_key_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*AccessKeyStatus); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_nebius_iam_v1_access_key_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_nebius_iam_v1_access_key_proto_rawDesc = nil
