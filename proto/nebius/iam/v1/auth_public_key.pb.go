...
const file_nebius_iam_v1_auth_public_key_proto_rawDesc = "" +
	...
	"\x06status\x18\x03 \x01(\v2\".nebius.iam.v1.AuthPublicKeyStatusB\x04\xbaJ\x01\x05R\x06status:\x04\xbaJ\x01\x02\"\xc8\x01\n" +
	...
	"\bkey_size\x18\x04 \x01(\x05R\akeySize\"`\n" +
	"\x05State\x12\x15\n" +
...
var (
	...
	file_nebius_iam_v1_auth_public_key_proto_rawDescData []byte
)
...
func file_nebius_iam_v1_auth_public_key_proto_rawDescGZIP() []byte {
	file_nebius_iam_v1_auth_public_key_proto_rawDescOnce.Do(func() {
		file_nebius_iam_v1_auth_public_key_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_nebius_iam_v1_auth_public_key_proto_rawDesc), len(file_nebius_iam_v1_auth_public_key_proto_rawDesc)))
	})
...
func file_nebius_iam_v1_auth_public_key_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_nebius_iam_v1_auth_public_key_proto_rawDesc), len(file_nebius_iam_v1_auth_public_key_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
