...
func file_nebius_iam_v1_auth_public_key_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_nebius_iam_v1_auth_public_key_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*AuthPublicKey); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_nebius_iam_v1_auth_public_key_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*AuthPublicKeySpec); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_nebius_iam_v1_auth_public_key_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*AuthPublicKeyStatus); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
