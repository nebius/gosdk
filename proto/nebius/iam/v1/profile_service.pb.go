...
func (x *GetProfileResponse) GetUserProfile() *UserProfile {
	if x, ok := x.GetProfile().(*GetProfileResponse_UserProfile); ok {
...
func (x *GetProfileResponse) GetServiceAccountProfile() *ServiceAccountProfile {
	if x, ok := x.GetProfile().(*GetProfileResponse_ServiceAccountProfile); ok {
...
func (x *GetProfileResponse) GetAnonymousProfile() *AnonymousAccount {
	if x, ok := x.GetProfile().(*GetProfileResponse_AnonymousProfile); ok {
...
func (m *UserProfile) GetAttributesOptional() isUserProfile_AttributesOptional {
	if m != nil {
...
func (x *UserProfile) GetAttributes() *UserAttributes {
	if x, ok := x.GetAttributesOptional().(*UserProfile_Attributes); ok {
		return x.Attributes
	}
	return nil
}
...
func (x *UserProfile) GetRetrievingError() *Error {
	if x, ok := x.GetAttributesOptional().(*UserProfile_RetrievingError); ok {
...
var file_nebius_iam_v1_profile_service_proto_rawDesc = []byte{
...
var (
	...
	file_nebius_iam_v1_profile_service_proto_rawDescData = file_nebius_iam_v1_profile_service_proto_rawDesc
)
...
func file_nebius_iam_v1_profile_service_proto_rawDescGZIP() []byte {
	file_nebius_iam_v1_profile_service_proto_rawDescOnce.Do(func() {
		file_nebius_iam_v1_profile_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_nebius_iam_v1_profile_service_proto_rawDescData)
	})
...
func file_nebius_iam_v1_profile_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_nebius_iam_v1_profile_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_nebius_iam_v1_profile_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_nebius_iam_v1_profile_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_nebius_iam_v1_profile_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*UserTenantInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_nebius_iam_v1_profile_service_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*ServiceAccountProfile); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_nebius_iam_v1_profile_service_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*AnonymousAccount); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_nebius_iam_v1_profile_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_nebius_iam_v1_profile_service_proto_rawDesc = nil
