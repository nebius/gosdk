...
func (m *InvitationSpec) GetContact() isInvitationSpec_Contact {
	if m != nil {
		return m.Contact
	}
	return nil
...
func (x *InvitationSpec) GetEmail() string {
	if x, ok := x.GetContact().(*InvitationSpec_Email); ok {
		return x.Email
	}
	return ""
}
...
func file_nebius_iam_v1_invitation_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_nebius_iam_v1_invitation_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_nebius_iam_v1_invitation_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*InvitationSpec); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_nebius_iam_v1_invitation_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*InvitationStatus); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
