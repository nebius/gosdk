...
var file_nebius_iam_v1_access_permit_service_proto_rawDesc = []byte{
...
var (
	...
	file_nebius_iam_v1_access_permit_service_proto_rawDescData = file_nebius_iam_v1_access_permit_service_proto_rawDesc
)
...
func file_nebius_iam_v1_access_permit_service_proto_rawDescGZIP() []byte {
	file_nebius_iam_v1_access_permit_service_proto_rawDescOnce.Do(func() {
		file_nebius_iam_v1_access_permit_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_nebius_iam_v1_access_permit_service_proto_rawDescData)
	})
...
func file_nebius_iam_v1_access_permit_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_nebius_iam_v1_access_permit_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_nebius_iam_v1_access_permit_service_proto_rawDesc = nil
