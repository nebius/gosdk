...
// func (x *KeyIdentity) Sanitize()            // is not generated as no sensitive fields found
// func (x *KeyIdentity) LogValue() slog.Value // is not generated as no sensitive fields found

// func (x *GetAccessKeySecretOnceRequest) Sanitize()            // is not generated as no sensitive fields found
// func (x *GetAccessKeySecretOnceRequest) LogValue() slog.Value // is not generated as no sensitive fields found

// func (x *GetAccessKeyByIdRequest) Sanitize()            // is not generated as no sensitive fields found
// func (x *GetAccessKeyByIdRequest) LogValue() slog.Value // is not generated as no sensitive fields found
...
// Sanitize mutates [GetAccessKeySecretOnceResponse] to remove/mask all sensitive values.
// Sensitive fields are marked with [(nebius.sensitive) = true].
func (x *GetAccessKeySecretOnceResponse) Sanitize() {
	if x == nil {
		return
	}
	x.Secret = "***"
...
//
//	var original *GetAccessKeySecretOnceResponse
//	sanitized := original.LogValue().Any().(proto.Message)
//
// If you need to extract [GetAccessKeySecretOnceResponse], use the following code:
//
//	var original *GetAccessKeySecretOnceResponse
//	sanitized := original.LogValue().Any().(proto.Message).ProtoReflect().Interface().(*GetAccessKeySecretOnceResponse)
func (x *GetAccessKeySecretOnceResponse) LogValue() slog.Value {
	if x == nil {
		return slog.AnyValue(x)
	}
	c := proto.Clone(x).(*GetAccessKeySecretOnceResponse) // TODO: generate static cloner without protoreflect
	c.Sanitize()
	return slog.AnyValue((*wrapperGetAccessKeySecretOnceResponse)(c))
}

// wrapperGetAccessKeySecretOnceResponse is used to return [GetAccessKeySecretOnceResponse] not implementing [slog.LogValuer] to avoid recursion while resolving.
type wrapperGetAccessKeySecretOnceResponse GetAccessKeySecretOnceResponse

func (w *wrapperGetAccessKeySecretOnceResponse) String() string {
	return (*GetAccessKeySecretOnceResponse)(w).String()
}

func (*wrapperGetAccessKeySecretOnceResponse) ProtoMessage() {}

func (w *wrapperGetAccessKeySecretOnceResponse) ProtoReflect() protoreflect.Message {
	return (*GetAccessKeySecretOnceResponse)(w).ProtoReflect()
}
