...
// func (x *GetEndpointRequest) Sanitize()            // is not generated as no sensitive fields found
// func (x *GetEndpointRequest) LogValue() slog.Value // is not generated as no sensitive fields found

// func (x *GetEndpointByNameRequest) Sanitize()            // is not generated as no sensitive fields found
// func (x *GetEndpointByNameRequest) LogValue() slog.Value // is not generated as no sensitive fields found

// func (x *ListEndpointsRequest) Sanitize()            // is not generated as no sensitive fields found
// func (x *ListEndpointsRequest) LogValue() slog.Value // is not generated as no sensitive fields found
...
// func (x *DeleteEndpointRequest) Sanitize()            // is not generated as no sensitive fields found
// func (x *DeleteEndpointRequest) LogValue() slog.Value // is not generated as no sensitive fields found

// Sanitize mutates [UpdateEndpointRequest] to remove/mask all sensitive values.
// Sensitive fields are marked with [(nebius.sensitive) = true].
func (x *UpdateEndpointRequest) Sanitize() {
	if x == nil {
		return
	}
	x.Spec.Sanitize()
...
// LogValue implements [slog.LogValuer] interface. It returns sanitized copy of [UpdateEndpointRequest].
// Properly implemented [slog.Handler] must call LogValue, so sensitive values are not logged.
// Sensitive strings and bytes are masked with "**HIDDEN**", other sensitive fields are omitted.
//
// Returning value has kind [slog.KindAny]. To extract [proto.Message], use the following code:
//
//	var original *UpdateEndpointRequest
//	sanitized := original.LogValue().Any().(proto.Message)
//
// If you need to extract [UpdateEndpointRequest], use the following code:
//
//	var original *UpdateEndpointRequest
//	sanitized := original.LogValue().Any().(proto.Message).ProtoReflect().Interface().(*UpdateEndpointRequest)
func (x *UpdateEndpointRequest) LogValue() slog.Value {
	if x == nil {
		return slog.AnyValue(x)
	}
	c := proto.Clone(x).(*UpdateEndpointRequest) // TODO: generate static cloner without protoreflect
	c.Sanitize()
	return slog.AnyValue((*wrapperUpdateEndpointRequest)(c))
}

// wrapperUpdateEndpointRequest is used to return [UpdateEndpointRequest] not implementing [slog.LogValuer] to avoid recursion while resolving.
type wrapperUpdateEndpointRequest UpdateEndpointRequest

func (w *wrapperUpdateEndpointRequest) String() string {
	return (*UpdateEndpointRequest)(w).String()
}

func (*wrapperUpdateEndpointRequest) ProtoMessage() {}

func (w *wrapperUpdateEndpointRequest) ProtoReflect() protoreflect.Message {
	return (*UpdateEndpointRequest)(w).ProtoReflect()
}
