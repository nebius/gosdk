...
const (
	JobService_Get_FullMethodName       = "/nebius.ai.v1.JobService/Get"
	JobService_GetByName_FullMethodName = "/nebius.ai.v1.JobService/GetByName"
	JobService_List_FullMethodName      = "/nebius.ai.v1.JobService/List"
...
type JobServiceClient interface {
	...
	GetByName(ctx context.Context, in *GetJobByNameRequest, opts ...grpc.CallOption) (*Job, error)
...
func (c *jobServiceClient) GetByName(ctx context.Context, in *GetJobByNameRequest, opts ...grpc.CallOption) (*Job, error) {
	out := new(Job)
	err := c.cc.Invoke(ctx, JobService_GetByName_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *jobServiceClient) Delete(ctx context.Context, in *DeleteJobRequest, opts ...grpc.CallOption) (*v1.Operation, error) {
	out := new(v1.Operation)
...
type JobServiceServer interface {
	...
	// Returns the specified job by name.
	GetByName(context.Context, *GetJobByNameRequest) (*Job, error)
	// Retrieves a list of jobs.
...
func (UnimplementedJobServiceServer) GetByName(context.Context, *GetJobByNameRequest) (*Job, error) {
...
func (UnimplementedJobServiceServer) Delete(context.Context, *DeleteJobRequest) (*v1.Operation, error) {
...
func _JobService_GetByName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetJobByNameRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(JobServiceServer).GetByName(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: JobService_GetByName_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(JobServiceServer).GetByName(ctx, req.(*GetJobByNameRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var JobService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _JobService_GetByName_Handler,
		},
		{
			MethodName: "List",
	...
	Metadata: "nebius/ai/v1/job_service.proto",
}
