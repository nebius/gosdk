...
func init() {
	conn.ConventionResolverServiceIDToNameMap[ClusterServiceID] = "sp.msp"
}
...
const ClusterServiceID conn.ServiceID = "nebius.msp.spark.v1alpha1.ClusterService"
...
type ClusterService interface {
	...
	Create(context.Context, *v1alpha1.CreateClusterRequest, ...grpc.CallOption) (operations.Operation, error)
	Update(context.Context, *v1alpha1.UpdateClusterRequest, ...grpc.CallOption) (operations.Operation, error)
	Delete(context.Context, *v1alpha1.DeleteClusterRequest, ...grpc.CallOption) (operations.Operation, error)
...
func (s clusterService) Create(ctx context.Context, request *v1alpha1.CreateClusterRequest, opts ...grpc.CallOption) (operations.Operation, error) {
	address, err := s.sdk.Resolve(ctx, ClusterServiceID)
	if err != nil {
		return nil, err
	}
...
func (s clusterService) Update(ctx context.Context, request *v1alpha1.UpdateClusterRequest, opts ...grpc.CallOption) (operations.Operation, error) {
...
func (s clusterService) Delete(ctx context.Context, request *v1alpha1.DeleteClusterRequest, opts ...grpc.CallOption) (operations.Operation, error) {
	address, err := s.sdk.Resolve(ctx, ClusterServiceID)
	if err != nil {
		return nil, err
	}
...
func (s clusterService) GetOperation(ctx context.Context, request *v1.GetOperationRequest, opts ...grpc.CallOption) (operations.Operation, error) {
	address, err := s.sdk.Resolve(ctx, ClusterServiceID)
	if err != nil {
		return nil, err
	}
...
func (s clusterService) ListOperations(ctx context.Context, request *v1.ListOperationsRequest, opts ...grpc.CallOption) (*v1.ListOperationsResponse, error) {
	address, err := s.sdk.Resolve(ctx, ClusterServiceID)
	if err != nil {
		return nil, err
	}
